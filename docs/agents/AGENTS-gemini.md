...
1. **Consistency Check**: Ensure the design actually solves the requirement and the tasks cover the entire design.
1. **COMMIT SPECS**: Stage and commit the changes to `specs/` and `docs/` _before_ writing any implementation code. Use a commit message like `docs: update specs for [feature]`.
