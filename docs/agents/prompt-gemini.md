...
1. Replace the `[INSERT YOUR PROJECT DETAILS HERE]` section with your project's specific tech stack and directory structure.
1. Paste the completed prompt into your AI agent's chat interface.
1. Review and save the output as `AGENTS.md` in your project root.
