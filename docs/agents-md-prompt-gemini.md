...
2. **STRIP** prose: Remove "We use X because...", "Please remember to...", and history.
3. **MERGE** redundancy: One statement per constraint.
4. **DEFINE** precedence: Ensure the hierarchy of truth is clear.
5. **ADD** discovery: Mandate tool-based search over human inquiry.
